...
with DAG(
    ...
    # Pour ajouter le branching, nous devons créer une nouvelle tâche 
    # et une nouvelle fonction pour indiquer les conditions:
    import random
    ...
    # N'oublions pas de changer les dépendances:
